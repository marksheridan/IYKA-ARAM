...
export const posts: BlogPost[] = [
  {
    ...
    excerpt:
      "Discover how the three doshas — Vata, Pitta, and Kapha — shape your physical and mental constitution, and how knowing yours can transform your daily wellness routine.",
...
At IYKA-ARAM, our practitioners weave Ayurvedic principles into every consultation, helping you understand the root of imbalance rather than simply addressing its symptoms. Wellness, in this tradition, is not the absence of disease — it is the radiant expression of your natural state.`,
  },
  {
    ...
    excerpt:
      "Modern neuroscience is confirming what yogis have known for centuries — conscious breathing is one of the most powerful tools we have for regulating stress and restoring inner calm.",
...
At IYKA-ARAM, breathwork is integrated into our yoga and wellness sessions as both a standalone practice and a complement to Ayurvedic treatment. The breath, our teachers say, is always available — it is the most immediate medicine we carry.`,
  ...
  {
    slug: "the-healing-power-of-community",
    title: "The Healing Power of Community: Wellness Together",
    date: "2026-07-02",
    author: "IYKA-ARAM Wellness Team",
    category: "Community",
    coverImage: "/gallery/img11.jpg",
    excerpt:
      "Healing is rarely a solo journey. We explore why practising alongside others — laughing, breathing, and moving together — amplifies the benefits of every wellness discipline.",
    content: "",
  },
  {
    slug: "mudras-hand-gestures-for-wellbeing",
    title: "Mudras: Ancient Hand Gestures for Modern Wellbeing",
    date: "2026-07-09",
    author: "IYKA-ARAM Wellness Team",
    category: "Yoga & Breathwork",
    coverImage: "/gallery/img23.jpg",
    excerpt:
      "A mudra is a seal — a precise arrangement of the fingers that redirects prana through the body's energy channels. Discover five accessible mudras and when to use them.",
    content: "",
  },
  {
    slug: "your-first-ayurvedic-consultation",
    title: "Your First Ayurvedic Consultation: What to Expect",
    date: "2026-07-16",
    author: "IYKA-ARAM Wellness Team",
    category: "Ayurveda",
    coverImage: "/gallery/img17.jpg",
    excerpt:
      "Walking into your first Ayurvedic consultation can feel unfamiliar. Here is a calm, practical guide to what our practitioners observe, ask, and recommend in that first session.",
    content: "",
  },
  {
    slug: "yoga-for-every-body",
    title: "Yoga for Every Body: Movement as Medicine",
    date: "2026-07-23",
    author: "IYKA-ARAM Wellness Team",
    category: "Yoga & Breathwork",
    coverImage: "/gallery/img20.jpg",
    excerpt:
      "Yoga was never designed for the flexible or the young. We look at how mindful movement — adapted for every age, ability, and constitution — serves as one of the most democratic medicines available.",
    content: "",
  },
];
