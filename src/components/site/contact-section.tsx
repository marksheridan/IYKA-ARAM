        ...
        <div className="v2-contact-grid">
          ...
          <Reveal>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
              <a href={business.phoneHref} className="v2-contact-link">
              ...
              <a href={business.emailHref} className="v2-contact-link">
                <span className="v2-contact-icon">
                  <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5" viewBox="0 0 24 24">
          ...
          <Reveal delay={0.2} className="v2-contact-form-wrap">
            <form action={formAction} className="v2-contact-form">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="v2-btn v2-btn-gold bg-transparent text-[inherit] w-full justify-center"
